...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="generate *.lst file for LaMem")
    parser.add_argument('--gpus', type=str, default='0', help='the gpus will be used, e.g "0,1,2,3"')
    parser.add_argument('--data-dir', type=str, default='./', help='the input data directory')
    parser.add_argument('--model-save-prefix', type=str, default='model/lightened_cnn/lightened_cnn', help='the prefix of the model to save')
